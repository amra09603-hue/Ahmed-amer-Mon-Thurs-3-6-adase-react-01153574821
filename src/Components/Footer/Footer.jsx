...
import { FaHeart, FaLinkedin, FaSquareXTwitter, FaYoutube } from "react-icons/fa6";
  ...
  return (
    <>
      <footer className="relative w-full bg-neutral-950  ">
        <div className="absolute inset-0  bg-[radial-gradient(circle_1000px_at_50%_100px,#7c370a15,transparent)] pointer-events-none" />
        <div className="border border-gray-500/30 bg-gray-800/35 pt-14 pb-8 px-36 grid grid-cols-12 gap-9">
          <div className="col-span-3 text-gray-500 ">
            <div className="flex items-center">
              <span className="text-xl text-white p-4 pt-1 font-semibold bg-orange-500  rounded-xl ml-4">
                ع
              </span>
            ...
            <div className="my-7 text-sm">{siteInfo.description}</div>
            <div className="flex gap-6">
              <a
                className="hover:text-white hover:bg-orange-500 rounded-lg p-1"
          ...
          <div className="col-span-3 text-gray-500">
            <div className="flex gap-2 items-center">
              <div className="w-8 h-0.5 bg-gradient-to-r from-orange-500 to-amber-300 ml-2"></div>
          ...
          <div className="col-span-3 text-gray-500 p-1.5">
            <div className="flex gap-2 items-center">
              <div className="w-8 h-0.5 bg-gradient-to-r from-orange-500 to-amber-300 ml-2"></div>
              <div className="text-white font-semibold text-xl">
                ابقى على اطلاع
            ...
            <div className="mb-6">
              <input
                type="email"
                className=" border border-gray-400/20 text-heading mb-3 bg-black/30 rounded-xl focus:ring-brand focus:border-brand md:block w-64 px-3 py-2.5 shadow-xs placeholder:text-body"
                placeholder="ادخل بريدك الاكتروني"
              />
              <button
                type="button"
                className="bg-orange-500 cursor-pointer hover:-translate-y-1.5 duration-300 hover:bg-orange-600 text-white w-64 py-3 px-7 font-semibold  rounded-3xl"
              >
                اشتراك
              </button>
            </div>
        ...
        <div className="bg-gray-800/35 text-gray-400/50 text-sm p-8 px-36 flex items-center justify-between">
          <div >© 2026 عدسة. صنع بكل <FaHeart className="text-orange-600 inline mx-1" /> جميع الحقوق محفوظة</div>
          <div>سياسة الخصوصية <span className="mr-5">شروط الخدمة</span></div>
        </div>
      </footer>
    </>
  );
