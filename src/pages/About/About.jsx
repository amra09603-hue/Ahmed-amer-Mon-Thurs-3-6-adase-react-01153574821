...
import { FaGithubSquare, FaPenNib } from "react-icons/fa";
  ...
  return (
    <>
      ...
      <section className="relative w-full bg-neutral-950 bg-[linear-gradient(to_right,#80808012_2px,transparent_2px),linear-gradient(to_bottom,#80808012_2px,transparent_2px)] bg-[size:60px_60px]">
        ...
        <div className="relative z-10 text-center py-28 flex items-center justify-center">
          <div className="text-center">
            <div className=" border border-orange-400/30 w-32 mr-[46%] mb-10 flex items-center justify-center bg-amber-500/10 py-2 rounded-full ">
              ...
              <span className="text-orange-400 font-semibold opacity-90 text-sm">
                من نحن
              </span>
            </div>
            <div className="text-6xl font-semibold text-white mx-auto px-80">
              مهمتنا هي{" "}
              <span className="text-orange-400">الإعلام والإلهام</span>
              <div className="text-gray-400 my-10 text-[20px] leading-8 font-medium">
            ...
            <div className="flex justify-center gap-5 items-center mt-14">
              <div className="text-orange-400 hover:scale-105 duration-300 py-5 px-14 text-3xl rounded-3xl bg-mist-900/60 border border-gray-500/30">
                <HiUserGroup className="mr-10 mb-1 text-orange-500" />
                <span className="block font-semibold text-3xl">+2مليون</span>
                <span className="text-sm text-gray-600 ">قارئ شهريا</span>
              </div>

              <div className="text-orange-400 hover:scale-105 duration-300 py-[26px] px-[65px] text-2xl rounded-3xl bg-mist-900/60 border border-gray-500/30">
                <FaNewspaper className="mr-8 mb-1 text-orange-500" />
                <span className="block font-semibold text-3xl">+500</span>
                <span className="text-sm text-gray-600">مقالة منشورة</span>
              </div>

              <div className="text-orange-400 hover:scale-105 duration-300 py-[27px] px-[83px] text-2xl rounded-3xl bg-mist-900/60 border border-gray-500/30">
                <FaPenNib className="mb-1 mr-4 text-orange-500" />
                <span className="block font-semibold text-3xl">+50</span>
                <span className="text-sm text-gray-600">كاتب خبير</span>
              </div>

              <div className="text-orange-400 hover:scale-105 duration-300 py-[28px] px-[85px] text-2xl rounded-3xl bg-mist-900/60 border border-gray-500/30">
                <BsBookHalf className="mr-3 mb-1 text-orange-500" />
                <span className="block font-semibold text-3xl">15</span>
      ...
      <section className="bg-zinc-950/97 border-y border-gray-600/40 py-18">
        <div className="container mx-auto text-white p-8 pt-10">
          <div className="flex justify-center items-center gap-4">
            <div className="bg-gradient-to-r from-orange-500 to-amber-300 w-1.5 h-9 rounded-2xl"></div>
            <div className="text-4xl font-semibold">قيمنا</div>
            <div className="bg-gradient-to-r from-amber-300 to-orange-500 w-1.5 h-9 rounded-2xl"></div>
          </div>
          <p className="text-gray-300/80 text-center mt-5 mb-16 text-lg ">
            المبادئ التي توجه كل ما نقوم بإنشائه
          </p>
          <div className="grid grid-cols-12 gap-6 mx-auto text-center px-14">
            <div className="col-span-3 bg-zinc-900 border border-gray-500/50 rounded-2xl p-6 hover:bg-orange-500/30 hover:border-amber-600/70 group">
              <FaBullseye className="text-orange-500 text-4xl inline text-center" />
              <div className="text-white font-semibold my-3 mb-2 text-lg group-hover:text-orange-600">
                الجودة أولاً
              </div>
            ...
            <div className="col-span-3 bg-zinc-900 border border-gray-500/50 rounded-2xl p-6 hover:bg-orange-500/30 hover:border-amber-600/70 group">
              <BiSolidZap className="text-orange-500 text-4xl inline text-center" />
              <div className="text-white group-hover:text-orange-600 font-semibold my-3 mb-2 text-lg ">
                تركيز عملي
              </div>
              <div className="text-gray-300/80 text-sm ">
            ...
            <div className="col-span-3 bg-zinc-900 border border-gray-500/50 rounded-2xl p-6 hover:bg-orange-500/30 hover:border-amber-600/70 group">
              <LuHandshake className="text-orange-500 text-4xl inline text-center" />
              <div className="text-white font-semibold group-hover:text-orange-600 my-3 mb-2 text-lg ">
                {" "}
                المجتمع
              </div>
              <div className="text-gray-300/80 text-sm ">
            ...
            <div className="col-span-3 bg-zinc-900 border border-gray-500/50 rounded-2xl p-6 hover:bg-orange-500/30 hover:border-amber-600/70 group">
              <FiRefreshCw className="text-orange-500 group-hover:text-orange-600 text-4xl inline text-center" />
              <div className="text-white font-semibold my-3 mb-2 text-lg ">
                {" "}
                دائماً محدث
              </div>
              <div className="text-gray-300/80 text-sm ">
      ...
      <section className="relative w-full bg-neutral-950 pt-16 pb-5">
        ...
        <div className="container mx-auto text-white p-8 pt-10">
          <div className="border border-orange-400/30 w-24 mr-[46%] mb-7 flex items-center justify-center bg-amber-500/10 py-2 rounded-full ">
            <i className="fa-solid fa-circle fa-fade text-[9px] ml-2 text-orange-400"></i>
          ...
          <div className="text-gray-300/80 text-lg text-center mt-4 mb-8">
            ...
            {posts.map(function (current) {
              return (
                <div className="col-span-4 relative hover:border-amber-600 group bg-zinc-900/80 rounded-3xl p-6 border border-gray-400/20">
                  ...
                  />
                  <div className="absolute top-26 right-36 text-center px-2 pb-1 py-0 bg-orange-500 rounded-full">
                    <i className="text-white text-[8px]  fa-solid fa-check"></i>
                  </div>
                  ...
                  <div className="flex justify-center gap-4">
                    <a
                      className=" hover:bg-orange-500 hover:text-white text-gray-400/30 rounded-lg  "
      ...
      <section className="bg-gradient-to-r from-orange-600 to-amber-500 border-y border-gray-600/40 p-20 text-center">
        ...
        <Link to="blog">
          <button className="text-white cursor-pointer hover:text-black hover:bg-white  bg-transparent border border-gray-200/80 px-7 py-4 font-semibold rounded-xl mt-7">
            تصفح المقالات
          </button>
        </Link>
      </section>
