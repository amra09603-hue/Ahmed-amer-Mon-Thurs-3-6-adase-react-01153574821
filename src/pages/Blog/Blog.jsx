...
export default function Blog() {
  const [allData, setAllData] = useState([
    {
      posts: [
        ...
        },
        {
          ...
          title: "تصوير المواليد: فن التقاط الطفل البراءة",
  ...
  let [activeCategory, setActiveCategory] = useState(
    categoryForm || `جميع المقالات`,
  );
  let filterPosts = posts.filter((filter) => {
    let matchesCategory =
      activeCategory === "جميع المقالات" || filter.category === activeCategory;
    let matchesSearch =
  ...
  let bigCurrentCount = categories.find(
    (count) => count.name === activeCategory,
  );
  let currentCount = bigCurrentCount ? bigCurrentCount.count : 0;
  ...
  return (
    <>
      ...
      <section className="relative  bg-neutral-950 bg-[linear-gradient(to_right,#80808012_2px,transparent_2px),linear-gradient(to_bottom,#80808012_2px,transparent_2px)] bg-[size:60px_60px]">
        <div className="absolute inset-0  bg-[radial-gradient(circle_600px_at_40%_200px,#f9731615,transparent)] pointer-events-none" />
        <div className=" z-10 text-center py-24 flex items-center justify-center">
          <div className="text-center">
            <div className=" border border-orange-400/30 w-28 mr-44 mb-10 flex items-center justify-center bg-orange-400/10 py-1.5 rounded-full ">
              <i className="fa-solid fa-circle fa-fade text-[5px] ml-1  text-orange-500"></i>
              <span className="text-orange-500 font-semibold  text-sm">
                <i className="fa-regular fa-newspaper ml-2"></i>
                مدونتنا
              </span>
            </div>
            <div className="text-white text-6xl font-semibold">
              استكشف
              <span className="text-orange-400"> مقالاتنا</span>
            </div>
      ...
      <section className="relative w-full bg-neutral-950 pt-5 pb-14">
        ...
        <div className="container relative mx-auto text-white  ">
              ...
              <div className="max-w-md mx-auto">
                <div className="relative">
                  ...
                  <input
                    ...
                    className=" w-72 py-3 px-8  bg-gray-500/20 border border-gray-600/20  rounded-xl focus:border-amber-600 outline-0  shadow-xs placeholder:text-body"
              ...
              {categories.map((vir) => (
                <button
                  ...
                  className={` font-semibold rounded-xl ml-2 py-2 px-3 text-sm cursor-pointer border border-gray-500/30 hover:border-orange-600/50
                   ${
                     activeCategory === vir.name
                       ? "bg-orange-500 text-white"
                       : "bg-gray-500/10 text-gray-400/90"
                   }`}
                >
                  {vir.name}
                </button>
          ...
          <div className="border-b border-gray-400/20 w-full mt-5 ml-20"></div>
          <div className="pt-14  px-10">
            <div className="flex items-center justify-between my-7">
              <div className="text-gray-400/90">
                عرض
                <span className="text-white mx-1">{currentCount}</span>
                مقالات
              </div>
              <div className="border border-gray-400/20 bg-gray-500/10 p-1 px-1 rounded-xl ">
                <button
                  onClick={() => setVeiwMode(`grid`)}
                  className={`cursor-pointer hover:text-white text-lg ml-2 text-gray-400/90 p-1 rounded-lg 
                    ${
                      veiwMode === `grid`
                        ? `bg-orange-500 text-white`
                        : `text-gray-400/90 bg-transparent`
                    }`}
                >
                  <i className=" fa-solid fa-table-cells-large"></i>
                </button>
                <button
                  onClick={() => setVeiwMode(`list`)}
                  className={`cursor-pointer hover:text-white text-lg  text-gray-400/90 p-1 rounded-lg 
                    ${
                      veiwMode === `list`
                        ? `bg-orange-500 text-white`
                        : `text-gray-400/90 bg-transparent`
              ...
              {currentPages.map((current) => (
                <div className=" group  bg-neutral-primary-soft block  border border-gray-500/20  rounded-3xl shadow-xs">
                  ...
                  >
                    ...
                    <div
                      className={`sm:p-7 md:p-8 md:pb-10  lg:p-7 lg:pb-11 bg-zinc-900/80  ${veiwMode === `list` ? "rounded-l-3xl  w-full h-60 " : `rounded-b-3xl`}`}
                    >
                      ...
                      <div
                        className={`border-b border-gray-500/20 my-5 ${veiwMode === `list` ? "hidden " : ""}`}
                      ></div>
