...
import { FaFolderOpen, FaPenNib, FaStar } from "react-icons/fa";
...
export default function Home() {
  ...
  return (
    <>
      {/*  Hero Section */}
      <section className="relative w-full bg-neutral-950 bg-[linear-gradient(to_right,#80808012_2px,transparent_2px),linear-gradient(to_bottom,#80808012_2px,transparent_2px)] bg-[size:60px_60px]">
        <div className="absolute inset-0  bg-[radial-gradient(circle_500px_at_15%_200px,#f9731615,transparent)] pointer-events-none" />
        <div className="relative z-10 text-center py-20 flex items-center justify-center">
          <div className="text-center">
            <div className=" border border-orange-400/30 w-44 mr-64 mb-10 flex items-center justify-center bg-amber-500/10 py-2 rounded-full ">
              <i className="fa-solid fa-circle fa-fade text-[5px] ml-1  text-orange-500"></i>
              <i className="fa-solid fa-circle fa-fade text-[9px] ml-2 text-orange-500"></i>
            ...
            <div className="text-7xl font-semibold text-white">
              ...
              <span className="block my-5">التصوير الفوتوغرافي</span>
              <div className="text-gray-400 my-10 text-[23px] font-medium">
                انغمس في أسرار المحترفين ونصائح عملية لتطوير مهاراتك في
                <span className="block mt-4">التصوير.</span>
              </div>
            </div>
            <div className="flex items-center justify-center gap-4 pt-3">
              <Link to="blog">
                <button
                  type="button"
                  className="text-white group bg-orange-500 flex items-center gap-3 text-[16px] box-border  hover:-translate-y-0.5 cursor-pointer transition-all duration-300   shadow-xs font-semibold leading-5 rounded-full  px-8 py-5 "
                >
                  استكشف المقالات
                  <FaArrowLeftLong className="text-sm group-hover:-translate-x-1.5 transition-transform  duration-200" />
                </button>
              </Link>
              <Link to="about">
                <button
                  type="button"
                  className="text-white/90 hover:bg-amber-500/10 hover:text-amber-600 hover:border-amber-600 group bg-orange-500/0 flex items-center gap-2 text-[16px] box-border border border-white/20 cursor-pointer shadow-xs font-semibold leading-5 rounded-full  px-8 py-5 "
                >
                  <FiInfo className="text-lg group-hover:text-amber-600" />
                  اعرف المزيد
                </button>
              </Link>
            </div>
            <div className="flex justify-center gap-5 items-center mt-14">
              <div className="text-orange-400 hover:scale-105 duration-300 py-3 px-14 text-2xl rounded-2xl bg-mist-900/60 border border-gray-500/30">
                <FaNewspaper className="mr-3 mb-1 text-orange-500" />
                <span className="block font-semibold text-3xl">+50</span>
                <span className="text-sm text-gray-600">مقالة</span>
              </div>
              <div className="text-orange-400 hover:scale-105 duration-300 py-2 px-9 text-3xl rounded-2xl bg-mist-900/60 border border-gray-500/30">
                <HiUserGroup className="mr-8 mb-1 text-orange-500" />
                <span className="block font-semibold text-3xl">+10ألف</span>
                <span className="text-sm text-gray-600 ">قارئ</span>
              </div>
              <div className="text-orange-400 hover:scale-105 duration-300 py-3 px-12 text-2xl rounded-2xl bg-mist-900/60 border border-gray-500/30">
                <FaFolderOpen className="mr-3 mb-1 text-orange-500" />
      ...
      {/*  Articles Section*/}
      <section className="relative w-full bg-neutral-950 pt-16 pb-5">
        <div className="absolute inset-0 bg-[radial-gradient(circle_600px_at_98%_200px,#f9731615,transparent)] pointer-events-none" />
        <div className="container mx-auto text-white p-8 pt-10 ">
          <div className=" border border-orange-400/30 w-24  mb-5 flex items-center justify-center bg-amber-500/10 py-2 rounded-full ">
            <i className="fa-solid fa-circle fa-fade text-[5px] ml-1  text-orange-500"></i>
            <i className="fa-solid fa-circle fa-fade text-[9px] ml-2 text-orange-500"></i>
            <span className="text-orange-500  text-sm">مميز</span>
          </div>

          <div className="text-6xl font-semibold">مقالات مختارة</div>

          <div className="flex row justify-between items-center mb-10 mt-4">
            ...
            <Link to="blog">
              <button
                type="button"
                className="text-white group bg-orange-600 flex items-center gap-3 text-[16px] box-border  hover:-translate-y-0.5 cursor-pointer transition-all duration-300  shadow-xs font-medium leading-5 rounded-xl  px-5 py-3 "
              >
                عرض الكل
                <IoIosArrowBack className=" group-hover:-translate-x-1.5 transition-transform  duration-200" />
              </button>
            </Link>
          </div>
              ...
              <Link id={index} to={`/blog/${current.slug}`}>
                <div className="grid grid-cols-12 group hover:border hover:border-orange-600/30 rounded-3xl mb-10">
                  <div className="col-span-6 relative overflow-hidden  border border-gray-600/50 rounded-r-3xl ">
                    <img
                      src={current.image}
                      className="w-full h-full object-cover  rounded-r-3xl hover:scale-110 duration-400 transition-transform"
                      alt={current.slug}
                    />
                    <div className="absolute bg-gradient-to-r from-orange-500 to-amber-300 px-3 py-1 rounded-3xl text-[12px] font-semibold text-white top-3 right-4 flex items-center justify-center gap-2">
                      <FaStar />
                      <span> مميز</span>
                    </div>
                  </div>
                  <div className="col-span-6 p-10  bg-zinc-900/75 rounded-l-3xl  border border-gray-600/30">
                    <span className="text-orange-500 bg-amber-950/35 py-1 px-3 text-[12px] font-semibold rounded-3xl border border-orange-600/50">
                      {current.category}
                    </span>
                    <i className="fa-regular fa-clock ml-2 mr-3 text-sm text-gray-500"></i>
                    <span className="text-sm text-gray-400">
                      {current.readTime}
                    </span>
                    <p className="text-3xl my-5 font-semibold group-hover:text-orange-600">
                      {current.title}
                    </p>
                    <p className="text-gray-400 pb-10 ">{current.excerpt}</p>
                    <div className="flex items-center justify-between pt-20">
                      <div className="relative flex items-center justify-center gap-2">
                        ...
                        />
                        <div className="absolute bottom-0 right-9 rounded-full w-3 h-3 bg-orange-500"></div>
                        <div>
                      ...
                      <div className="text-orange-500">
                        <span className="font-semibold pl-3 text-sm ">
                          اقرأ المقال
                        </span>
      ...
      {/*  Categories Section */}
      <section className="bg-zinc-950/97 border-y border-gray-600/40 py-18">
        <div className="container mx-auto text-white p-8 pt-10">
          <div className="flex justify-center items-center ">
            <div className=" border  border-orange-400/60 p-5  mb-8 flex items-center justify-center bg-orange-700/20 py-2 rounded-full ">
              <i className="fa-solid fa-circle fa-fade text-[5px] ml-1  text-orange-500"></i>
              <i className="fa-solid fa-circle fa-fade text-[9px] ml-2 text-orange-500"></i>
              <span className="text-orange-500 font-semibold opacity-90 text-sm">
                التصنيفات
              </span>
            </div>
          </div>
          <div className="text-6xl font-semibold text-center mb-7">
            استكشف حسب الموضوع
          </div>
          ...
          <div className="grid grid-cols-12 gap-6 ">
            <Link to={`/blog?category=إضاءة`} className="col-span-3 relative hover:bg-gradient-to-r hover:from-orange-500 group hover:-translate-y-3 duration-600 transition-all hover:to-amber-300 cursor-pointer border border-gray-400/20 p-6 bg-gray-700/10 rounded-2xl">
              <div className="text-white text-sm absolute top-16 left-14 opacity-0 group-hover:opacity-100  ">
                <i className="fa-solid fa-angle-left py-2 px-3 border border-amber-600/40 pl-5 rounded-full bg-amber-200/20 "></i>
              </div>
              <i className="fa-solid fa-gear text-xl text-orange-500 border group-hover:text-white border-amber-600/70 bg-amber-700/30 py-3 px-3.5 pl-8  rounded-xl"></i>
              <div className="font-semibold text-white text-xl mt-4 mb-2">
                {categories[0].name}
              </div>
              <div className=" text-gray-200/30 group-hover:text-gray-200 text-sm mb-1 ">
                {categories[0].count} مقالة
              </div>
            </Link>
            <Link to={`/blog?category=بورتريه`} className="col-span-3 relative hover:bg-gradient-to-r hover:from-orange-500 group hover:-translate-y-3 duration-600 transition-all hover:to-amber-300 cursor-pointer border border-gray-400/20 p-6 bg-gray-700/10 rounded-2xl">
              <div className="text-white text-sm absolute top-16 left-14 opacity-0 group-hover:opacity-100  ">
                <i className="fa-solid fa-angle-left py-2 px-3 border border-amber-600/40 pl-5 rounded-full bg-amber-200/20 "></i>
              </div>
              <i className="fa-solid fa-user text-xl text-orange-500 border group-hover:text-white border-amber-600/70 bg-amber-700/30 py-3 px-3.5 pl-8  rounded-xl"></i>
              <div className="font-semibold text-white text-xl mt-4 mb-2">
                {categories[1].name}
              </div>
              <div className=" text-gray-200/30 group-hover:text-gray-200 text-sm mb-1">
            ...
            <Link to={`/blog?category=مناظرطبيعية`} className="col-span-3 relative hover:bg-gradient-to-r hover:from-orange-500 group hover:-translate-y-3 duration-600 transition-all hover:to-amber-300 cursor-pointer border border-gray-400/20 p-6 bg-gray-700/10 rounded-2xl">
              <div className="text-white text-sm absolute top-16 left-14 opacity-0 group-hover:opacity-100  ">
                <i className="fa-solid fa-angle-left py-2 px-3 border border-amber-600/40 pl-5 rounded-full bg-amber-200/20 "></i>
              </div>
              <i className="fa-solid fa-mountain-sun text-xl group-hover:text-white text-orange-500 border border-amber-600/70 bg-amber-700/30 py-3 px-3.5 pl-8  rounded-xl"></i>
              <div className="font-semibold text-white text-xl mt-4 mb-2">
                {categories[2].name}
              </div>
              <div className=" text-gray-200/30 group-hover:text-gray-200 text-sm mb-1">
            ...
            <Link to={`/blog?category=تقنيات`} className="col-span-3 relative hover:bg-gradient-to-r hover:from-orange-500 group hover:-translate-y-3 duration-600 transition-all hover:to-amber-300 cursor-pointer border border-gray-400/20 p-6 bg-gray-700/10 rounded-2xl">
              <div className="text-white text-sm absolute top-16 left-14 opacity-0 group-hover:opacity-100  ">
                <i className="fa-solid fa-angle-left py-2 px-3 border border-amber-600/40 pl-5 rounded-full bg-amber-200/20 "></i>
              </div>
              <i className="fa-solid fa-sliders text-xl group-hover:text-white text-orange-500 border border-amber-600/70 bg-amber-700/30 py-3 px-3.5 pl-8  rounded-xl"></i>
              <div className="font-semibold text-white text-xl mt-4 mb-2">
                {categories[3].name}
              </div>
              <div className=" text-gray-200/30 group-hover:text-gray-200 text-sm mb-1">
            ...
            <Link to={`/blog?category=معدات`} className="col-span-3 relative hover:bg-gradient-to-r hover:from-orange-500 group hover:-translate-y-3 duration-600 transition-all hover:to-amber-300 cursor-pointer border border-gray-400/20 p-6 bg-gray-700/10 rounded-2xl">
              <div className="text-white text-sm absolute top-16 left-14 opacity-0 group-hover:opacity-100  ">
                <i className="fa-solid fa-angle-left py-2 px-3 border border-amber-600/40 pl-5 rounded-full bg-amber-200/20 "></i>
              </div>
              <i className="fa-solid fa-gear text-xl group-hover:text-white text-orange-500 border border-amber-600/70 bg-amber-700/30 py-3 px-3.5 pl-8  rounded-xl"></i>
              <div className="font-semibold text-white text-xl mt-4 mb-2">
                {categories[4].name}
              </div>
              <div className=" text-gray-200/30 group-hover:text-gray-200 text-sm mb-1">
      ...
      <section className="relative w-full bg-neutral-950 pt-16 pb-20">
        <div className="absolute inset-0  bg-[radial-gradient(circle_800px_at_10%_200px,#f9731615,transparent)] pointer-events-none" />
        <div className="container mx-auto text-white p-8 pt-10 ">
          <div className=" border border-orange-400/30 w-24  mb-5 flex items-center justify-center bg-amber-500/10 py-2 rounded-full ">
            <i className="fa-solid fa-circle fa-fade text-[5px] ml-1  text-orange-500"></i>
            <i className="fa-solid fa-circle fa-fade text-[9px] ml-2 text-orange-500"></i>
            <span className="text-orange-500  text-sm">الأحدث</span>
          </div>

          <div className="text-6xl font-semibold"> أحدث المقالات</div>
          ...
          <div className="flex row justify-between items-center mb-10 mt-4">
            ...
            <Link to="blog">
              <button
                type="button"
                className="text-orange-400 group bg-transparent flex items-center gap-3 text-[16px] box-border  hover:-translate-y-0.5 cursor-pointer transition-all duration-300  shadow-xs font-medium leading-5 rounded-xl  px-5 py-3 "
              >
                عرض جميع المقالات
              ...
              .map((current,index) => (
                <div id={index} className="col-span-4 group hover:-translate-y-3 duration-300 bg-neutral-primary-soft block  border border-gray-500/20  rounded-3xl shadow-xs">
                  <Link to={`/blog/${current.slug}`}>
                    ...
                    <div className="sm:p-7 md:p-8 md:pb-10 lg:p-7 lg:pb-11 bg-zinc-900/80 rounded-b-3xl">
                      <div className=" mb-3 text-[12px] text-gray-200/50">
                        <i className="fa-regular fa-clock ml-1"></i>
                        <span>{current.readTime}</span>
                        <i className="fa-solid fa-circle mx-2.5 text-[4px]"></i>
                        <span>٨ يناير ٢٠٢٦</span>
                      </div>
                      <div className="text-xl font-semibold mb-3 group-hover:text-orange-600">
                        {current.title}
                      </div>
                      <div className="mb-3 text-[14px] text-gray-200/60">
                        {current.excerpt}
                      </div>
                      <div className="border-b border-gray-500/20 my-5"></div>
                      ...
                      <div className="flex items-center justify-between ">
                        ...
                        <div className="text-orange-500">
                          <i className="fa-solid fa-angle-left py-2 px-3.5 border group-hover:text-white duration-300 group-hover:bg-orange-500 border-amber-600/40 pl-5 rounded-full bg-amber-700/20 "></i>
                        </div>
                      </div>
                    </div>
                  </Link>
      ...
      {/*  Subscribe Section */}
      <section className="relative w-full bg-neutral-950 pt-16 pb-20">
        <div className="absolute inset-0  bg-[radial-gradient(circle_500px_at_50%_100px,#f9731615,transparent)] pointer-events-none" />
        <div className="container mx-auto text-center flex justify-center text-white p-8 pt-10">
          <div className="border border-gray-500/30 bg-gray-800/35 py-16 px-40 rounded-3xl">
            <i className="fa-regular fa-envelope mb-7 text-2xl text-white bg-orange-600 py-4 px-4 rounded-2xl pl-10"></i>
            <div className="text-4xl font-semibold">
              اشترك في <span className="text-orange-400">نشرتنا الإخبارية</span>
            </div>
            <p className="text-gray-300/50 my-5">
            ...
            <div className="mb-6 md:flex">
              <input
                type="email"
                className=" border border-gray-400/50 text-heading  bg-black rounded-xl focus:ring-brand focus:border-brand md:block w-92 px-3 py-3.5 shadow-xs placeholder:text-body"
                placeholder="ادخل بريدك الاكتروني"
              />
              <button
                type="button"
                className="bg-orange-500 cursor-pointer sm:w-full sm:ml-5 sm:block sm:mr-0 sm:mt-2 md:mt-0 md:mr-3 md:w-auto hover:bg-orange-600 text-white py-4 px-7 font-semibold mr-3 rounded-xl"
              >
                اشتراك الان
              </button>
            </div>
            <div className="flex justify-start items-center text-sm text-gray-600">
              ...
              <div className="ml-7">بدون إزعاج</div>
